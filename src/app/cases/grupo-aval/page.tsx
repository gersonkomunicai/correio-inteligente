...
//             <div className="md:flex h-auto pt-20 md:h-screen items-center justify-center bg-correio-inteligente-200">
//                 <Reveal direction="left">
//                     <div className="flex flex-col">
//                         <div className="flex p-2 md:p-0 relative items-center justify-center md:justify-start">
...
//                         </div>
//                         <div className="flex flex-col relative h-auto text-center md:text-left md:w-160">
...
//                     <div className="md:ml-10 flex items-center justify-between ml-4 my-10">
...
//                     <Reveal direction="left">
//                         <div className="flex items-center justify-center md:w-80 md:h-60 rounded-lg bg-correio-inteligente-200">
//                             <img className="w-30 md:aspect-square md:w-full" src="/aval.png" alt="" />
//                         </div>
//                     </Reveal>
//                     <div className="">
//                         <Reveal direction="right" className="flex flex-col md:ml-10">
//                             <div className="flex pb-5 mt-20 md:mt-0 justify-center md:justify-start bg-correio-inteligente-900 container">
...
//                             </div>
//                             <p className="md:text-left text-center text-lg">Há mais de 42 anos, o Grupo Aval atua no mercado financeiro oferecendo serviços especializados voltados à localização, contato e relacionamento com clientes, além da condução de processos relacionados à regularização de pendências financeiras.
...
//                             <Reveal direction="left">
//                                 <div className="w-100 md:min-w-200">
//                                     <img src="/handshake.jpeg" className="" alt="" />
//                                 </div>
//                             </Reveal>
//                             <Reveal direction="right">
//                                 <div className="flex flex-col">
...
//                                     </div>
//                                     <div className="ml-40">
//                                         <span className="flex flex-col text-center mt-10 md:mt-0 md:text-left text-correio-inteligente-900 text-lg">Para atender às necessidades do Grupo Aval, o Correio Inteligente passou a apoiar a operação de comunicação com uma estrutura mais ágil, automatizada e preparada para grandes volumes de mensagens.
...
//                                         <span className="text-lg flex text-center md:text-left text-correio-inteligente-900">Dessa forma, o Grupo Aval ganhou maior capacidade para alcançar sua base de contatos e manter uma comunicação mais frequente e organizada durante os processos de cobrança.
