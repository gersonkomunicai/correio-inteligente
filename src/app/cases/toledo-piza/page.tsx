...
//                             <img src="/toledo.png" className="max-w-20" alt="" />
//                             <Ampersand className="ml-2 size-4 text-gray-100" />
//                             <img src="/Iso.png" className="max-h-15" alt="" />
//                         </div>
//                         <div className="flex flex-col h-auto text-center md:text-left md:w-160">
...
//                         <img src="/ceo3.jpeg" className="bg-top w-120 h-120 object-cover rounded-br-md rounded-bl-4xl rounded-tr-4xl" alt="" />
//                     </div>
//                 </Reveal>
//             </div>
...
//                     <Reveal direction="left">
//                         <div className="flex mb-5 items-center justify-center md:w-80 md:h-60 rounded-lg bg-correio-inteligente-200">
//                             <img className="w-30 md:aspect-square md:w-full" src="/toledo.png" alt="" />
//                         </div>
//                     </Reveal>
//                     <div className="">
//                         <Reveal direction="right" className="flex flex-col md:ml-10">
//                             <div className="flex pb-5 bg-correio-inteligente-900 container">
//                                 <h2 className="text-4xl bg-linear-to-r from-correio-inteligente-200 to-correio-inteligente-800 bg-clip-text text-transparent">Experiência jurídica aliada a <span className="font-bold">eficiência operacional</span></h2>
//                             </div>
//                             <p className="text-lg">Com uma atuação especializada e processos que envolvem um grande volume de contatos e negociações, a Toledo Piza busca constantemente aprimorar sua operação e oferecer uma comunicação mais eficiente aos clientes.
...
//                                             <h2 className="bg-linear-to-r from-gray-100 to-correio-inteligente-800 bg-clip-text md:text-left text-center text-transparent pb-5 text-4xl md:mr-10 md:text-5xl">Como o <span className="font-bold">Correio Inteligente</span> ajudou</h2>
//                                         </div>
//                                         <span className="flex flex-col text-center mt-10 md:mt-0 md:text-left text-correio-inteligente-900 text-lg">Para apoiar a operação da Toledo Piza, o Correio Inteligente trouxe mais automação, escala e organização para a comunicação com os clientes.
