                ...
                <div className="flex items-center justify-center h-screen">
                    <div className="flex container items-start justify-start">
                        ...
                        {/* <Reveal direction="right">
                            <Image width={1000} height={1000} src="/heroEducation.png" className="hidden md:flex md:relative md:max-w-2xl md:rounded-bl-4xl md:rounded-tl-xl md:rounded-br-lg" alt="" />
                        </Reveal> */}
                    </div>
                </div>
            </div>
