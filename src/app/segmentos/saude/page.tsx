                ...
                <div className="flex items-center justify-center h-screen">
                    <div className="flex container items-start justify-start">
                        ...
                        {/* <Reveal direction="right">
                            <Image width={1000} height={1000} src="/health.png" className="hidden md:flex md:relative md:max-w-2xl md:rounded-bl-4xl md:rounded-tl-xl md:rounded-br-lg" alt="" />
                        </Reveal> */}
                    </div>
                </div>
            </div>
                    ...
                    <div className="lg:flex text-center items-start text-correio-inteligente-100 justify-between">
                        <div className="flex flex-col items-center max-w-xl">
                            ...
                            <div className="flex justify-center items-center w-160">
                                ...
                                <Image width={1000} height={1000} src="/health.png" className="hidden lg:flex rounded-bl-4xl rounded-tl-2xl rounded-tr-xl" alt="" />
                            </div>
                        </div>
