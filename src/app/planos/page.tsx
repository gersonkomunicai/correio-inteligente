    ...
    return (
        <div className="flex w-screen scroll-smooth overflow-clip snap-y snap-mandatory flex-col">
            ...
            <div id="preco" className="flex snap-center flex-col items-center py-16 justify-start h-auto bg-gray-100">
                ...
                <div className="flex items-start justify-center flex-wrap mt-10">
                    ...
                    <div className="flex bg-gray-100 justify-center ">
                        <p className="text-xs text-correio-inteligente-200">*Preço por envio levando em consideração o mínimo de 100.000 mensagens enviadas.</p>
                    </div>
                </div>
            </div>
            <Cta className="flex h-200 p-10 items-center justify-center bg-correio-inteligente-200"
                ...
                description="Converse com nosso time e descubra a melhor solução para automatizar seus envios e potencializar os resultados da sua empresa."></Cta>
        </div>
    )
}
// export default () => {
