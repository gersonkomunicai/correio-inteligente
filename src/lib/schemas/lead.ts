...
export const leadSchema = z.object({
  ...
  // Os dois aceites precisam vir marcados (true) para o envio ser aceito
  acceptsCommunication: z.literal(true, {
    message: "É necessário aceitar receber comunicações.",
  }),
