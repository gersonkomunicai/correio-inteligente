...
export default function CardWho({ menuItems }: CardWhoProps,) {
    return (
        <div className='flex gap-4'>
            {menuItems.map((item) => {
                return (
                    <div key={item.id} className="flex flex-col w-70 h-70 flex-wrap p-3 bg-linear-to-r from-correio-inteligente-900 to-correio-inteligente-800 rounded-xl items-start">
