                ...
                <div className="flex items-center h-auto ">
                    ...
                    <div className="flex items-center justify-between px-10 w-170">
                        ...
                        <div className="relative group">
                            ...
                            <div className="absolute hidden group-hover:flex flex-col top-full left-0 pt-2 min-w-40">
                                <div className="flex flex-col rounded-md bg-correio-inteligente-200 p-2 gap-1 shadow-xl">
                                    <a href="/cases/grupo-aval" className={`${url[2] === 'grupo-aval' ? 'text-gray-100 bg-correio-inteligente-800 ' : 'hover:text-gray-700 text-gray-100 hover:bg-correio-inteligente-900'} transition-all duration-200 ease-in font-bold text-base rounded-md p-2 `}>Grupo Aval</a>
                                    <a href="/cases/bellinati-perez" className={`${url[2] === 'bellinati-perez' ? 'text-gray-100 bg-correio-inteligente-800 ' : 'hover:text-gray-700 text-gray-100 hover:bg-correio-inteligente-900'} transition-all duration-200 ease-in font-bold text-base rounded-md p-2 `}>Bellinati Perez</a>
                                    <a href="/cases/toledo-piza" className={`${url[2] === 'toledo-piza' ? 'text-gray-100 bg-correio-inteligente-800 ' : 'hover:text-gray-700 text-gray-100 hover:bg-correio-inteligente-900'} transition-all duration-200 ease-in font-bold text-base rounded-md p-2 `}>Toledo Piza</a>
                                </div>
                            </div>
                        </div>
