    ...
    return (
        <div className='grid grid-cols-3 gap-4'>
            {menuDemonstrations.map((item) => {
                return (
                    <div key={item.id} className="flex flex-col w-80 h-35 p-3 bg-konnectai-primary rounded-xl items-center hover:bg-correio-inteligente-200 transition-all duration-200 ease-in">
